...
<div class="max-w-md mx-auto">
    @if(isset($pregunta->configuracion['tipo_respuesta']) && $pregunta->configuracion['tipo_respuesta'] === 'numero')
        ...
        <input 
            ...
            class="w-full px-3 py-2 text-xl text-center border-3 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
            placeholder="0">
    @else
        ...
        <textarea 
            id="respuesta-texto"
            rows="3"
            class="w-full px-3 py-2 border-3 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-sm"
